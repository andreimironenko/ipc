...
override PKGDIR = ti/sdo/ipc/interfaces
...
package/%.xdc.inc package/%_ti.sdo.ipc.interfaces.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ipc.interfaces" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ipc.interfaces $@

.libraries,em3 .libraries: lib/debug/ti.sdo.ipc.interfaces.aem3

-include lib/debug/ti.sdo.ipc.interfaces.aem3.mak
lib/debug/ti.sdo.ipc.interfaces.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/ti.sdo.ipc.interfaces/package/package_ti.sdo.ipc.interfaces.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/ar470  rq $@   package/lib/lib/debug/ti.sdo.ipc.interfaces/package/package_ti.sdo.ipc.interfaces.oem3 
lib/debug/ti.sdo.ipc.interfaces.aem3: export C_DIR=
lib/debug/ti.sdo.ipc.interfaces.aem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

clean,em3 clean::
	-$(RM) lib/debug/ti.sdo.ipc.interfaces.aem3
.libraries,e674 .libraries: lib/debug/ti.sdo.ipc.interfaces.ae674

-include lib/debug/ti.sdo.ipc.interfaces.ae674.mak
lib/debug/ti.sdo.ipc.interfaces.ae674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/ti.sdo.ipc.interfaces/package/package_ti.sdo.ipc.interfaces.oe674  into $@ ...
	$(ti.targets.elf.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/debug/ti.sdo.ipc.interfaces/package/package_ti.sdo.ipc.interfaces.oe674 
lib/debug/ti.sdo.ipc.interfaces.ae674: export C_DIR=
lib/debug/ti.sdo.ipc.interfaces.ae674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/:$(PATH)

clean,e674 clean::
	-$(RM) lib/debug/ti.sdo.ipc.interfaces.ae674
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.sdo.ipc.interfaces.oem3,copy : package/lib/lib/debug/ti.sdo.ipc.interfaces/package/package_ti.sdo.ipc.interfaces.oem3
package_ti.sdo.ipc.interfaces.sem3,copy : package/lib/lib/debug/ti.sdo.ipc.interfaces/package/package_ti.sdo.ipc.interfaces.sem3
package_ti.sdo.ipc.interfaces.oe674,copy : package/lib/lib/debug/ti.sdo.ipc.interfaces/package/package_ti.sdo.ipc.interfaces.oe674
package_ti.sdo.ipc.interfaces.se674,copy : package/lib/lib/debug/ti.sdo.ipc.interfaces/package/package_ti.sdo.ipc.interfaces.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_ipc_interfaces
ti_sdo_ipc_interfaces.tar: package/package.bld.xml
ti_sdo_ipc_interfaces.tar: package/package.ext.xml
ti_sdo_ipc_interfaces.tar: package/package.rel.dot
ti_sdo_ipc_interfaces.tar: package/build.cfg
ti_sdo_ipc_interfaces.tar: package/package.xdc.inc
ti_sdo_ipc_interfaces.tar: package.bld
ti_sdo_ipc_interfaces.tar: package/package.cfg.xdc.inc
ti_sdo_ipc_interfaces.tar: lib/debug/ti.sdo.ipc.interfaces.aem3
ti_sdo_ipc_interfaces.tar: package/package_ti.sdo.ipc.interfaces.c
ti_sdo_ipc_interfaces.tar: lib/debug/ti.sdo.ipc.interfaces.ae674
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ipc_interfaces.tar.dep
endif
package/rel/ti_sdo_ipc_interfaces/ti/sdo/ipc/interfaces/package/package.rel.xml:

ti_sdo_ipc_interfaces.tar: package/rel/ti_sdo_ipc_interfaces.xdc.inc package/rel/ti_sdo_ipc_interfaces/ti/sdo/ipc/interfaces/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ipc_interfaces.xdc.inc,package/rel/ti_sdo_ipc_interfaces.tar.dep)


release release,ti_sdo_ipc_interfaces: all ti_sdo_ipc_interfaces.tar
clean:: .clean
	-$(RM) ti_sdo_ipc_interfaces.tar
	-$(RM) package/rel/ti_sdo_ipc_interfaces.xdc.inc
	-$(RM) package/rel/ti_sdo_ipc_interfaces.tar.dep
...
ifeq (,$(wildcard package/lib/lib/debug/ti.sdo.ipc.interfaces))
    $(shell $(MKDIR) package/lib/lib/debug/ti.sdo.ipc.interfaces)
endif
ifeq (,$(wildcard package/lib/lib/debug/ti.sdo.ipc.interfaces/package))
    $(shell $(MKDIR) package/lib/lib/debug/ti.sdo.ipc.interfaces/package)
endif
endif
clean::
	-$(RMDIR) package
...
clean:: 
	-$(RM) package/ti.sdo.ipc.interfaces.pjt
