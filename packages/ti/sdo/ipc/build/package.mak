...
override PKGDIR = ti/sdo/ipc/build
...
package/%.xdc.inc package/%_ti.sdo.ipc.build.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ipc.build" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ipc.build $@
...
.PHONY: release,ti_sdo_ipc_build
ti_sdo_ipc_build.tar: package/package.bld.xml
ti_sdo_ipc_build.tar: package/package.ext.xml
ti_sdo_ipc_build.tar: package/package.rel.dot
ti_sdo_ipc_build.tar: package/build.cfg
ti_sdo_ipc_build.tar: package/package.xdc.inc
ti_sdo_ipc_build.tar: test.bld
ti_sdo_ipc_build.tar: common.bld
ti_sdo_ipc_build.tar: package.bld
ti_sdo_ipc_build.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ipc_build.tar.dep
endif
package/rel/ti_sdo_ipc_build/ti/sdo/ipc/build/package/package.rel.xml:

ti_sdo_ipc_build.tar: package/rel/ti_sdo_ipc_build.xdc.inc package/rel/ti_sdo_ipc_build/ti/sdo/ipc/build/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ipc_build.xdc.inc,package/rel/ti_sdo_ipc_build.tar.dep)


release release,ti_sdo_ipc_build: all ti_sdo_ipc_build.tar
clean:: .clean
	-$(RM) ti_sdo_ipc_build.tar
	-$(RM) package/rel/ti_sdo_ipc_build.xdc.inc
	-$(RM) package/rel/ti_sdo_ipc_build.tar.dep
