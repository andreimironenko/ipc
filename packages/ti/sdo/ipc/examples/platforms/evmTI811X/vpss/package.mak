...
override PKGDIR = ti/sdo/ipc/examples/platforms/evmTI811X/vpss
...
package/%.xdc.inc package/%_ti.sdo.ipc.examples.platforms.evmTI811X.vpss.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ipc.examples.platforms.evmTI811X.vpss" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ipc.examples.platforms.evmTI811X.vpss $@
...
.PHONY: release,ti_sdo_ipc_examples_platforms_evmTI811X_vpss
ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip: package/package.bld.xml
ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip: package/package.ext.xml
ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip: package/package.rel.dot
ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip: package/build.cfg
ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip: package/package.xdc.inc
ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip.dep
endif
package/rel/ti_sdo_ipc_examples_platforms_evmTI811X_vpss/ti/sdo/ipc/examples/platforms/evmTI811X/vpss/package/package.rel.xml:

ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip: package/rel/ti_sdo_ipc_examples_platforms_evmTI811X_vpss.xdc.inc package/rel/ti_sdo_ipc_examples_platforms_evmTI811X_vpss/ti/sdo/ipc/examples/platforms/evmTI811X/vpss/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/ti_sdo_ipc_examples_platforms_evmTI811X_vpss.xdc.inc,package/rel/ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip.dep)


release release,ti_sdo_ipc_examples_platforms_evmTI811X_vpss: all ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip
clean:: .clean
	-$(RM) ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip
	-$(RM) package/rel/ti_sdo_ipc_examples_platforms_evmTI811X_vpss.xdc.inc
	-$(RM) package/rel/ti_sdo_ipc_examples_platforms_evmTI811X_vpss.zip.dep
