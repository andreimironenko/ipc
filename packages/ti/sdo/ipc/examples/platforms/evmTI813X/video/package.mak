...
override PKGDIR = ti/sdo/ipc/examples/platforms/evmTI813X/video
...
package/%.xdc.inc package/%_ti.sdo.ipc.examples.platforms.evmTI813X.video.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ipc.examples.platforms.evmTI813X.video" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ipc.examples.platforms.evmTI813X.video $@
...
.PHONY: release,ti_sdo_ipc_examples_platforms_evmTI813X_video
ti_sdo_ipc_examples_platforms_evmTI813X_video.zip: package/package.bld.xml
ti_sdo_ipc_examples_platforms_evmTI813X_video.zip: package/package.ext.xml
ti_sdo_ipc_examples_platforms_evmTI813X_video.zip: package/package.rel.dot
ti_sdo_ipc_examples_platforms_evmTI813X_video.zip: package/build.cfg
ti_sdo_ipc_examples_platforms_evmTI813X_video.zip: package/package.xdc.inc
ti_sdo_ipc_examples_platforms_evmTI813X_video.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ipc_examples_platforms_evmTI813X_video.zip.dep
endif
package/rel/ti_sdo_ipc_examples_platforms_evmTI813X_video/ti/sdo/ipc/examples/platforms/evmTI813X/video/package/package.rel.xml:

ti_sdo_ipc_examples_platforms_evmTI813X_video.zip: package/rel/ti_sdo_ipc_examples_platforms_evmTI813X_video.xdc.inc package/rel/ti_sdo_ipc_examples_platforms_evmTI813X_video/ti/sdo/ipc/examples/platforms/evmTI813X/video/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/ti_sdo_ipc_examples_platforms_evmTI813X_video.xdc.inc,package/rel/ti_sdo_ipc_examples_platforms_evmTI813X_video.zip.dep)


release release,ti_sdo_ipc_examples_platforms_evmTI813X_video: all ti_sdo_ipc_examples_platforms_evmTI813X_video.zip
clean:: .clean
	-$(RM) ti_sdo_ipc_examples_platforms_evmTI813X_video.zip
	-$(RM) package/rel/ti_sdo_ipc_examples_platforms_evmTI813X_video.xdc.inc
	-$(RM) package/rel/ti_sdo_ipc_examples_platforms_evmTI813X_video.zip.dep
