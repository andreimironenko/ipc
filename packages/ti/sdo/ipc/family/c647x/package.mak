...
override PKGDIR = ti/sdo/ipc/family/c647x
...
package/%.xdc.inc package/%_ti.sdo.ipc.family.c647x.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ipc.family.c647x" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ipc.family.c647x $@
...
.PHONY: release,ti_sdo_ipc_family_c647x
ti_sdo_ipc_family_c647x.tar: package/package.bld.xml
ti_sdo_ipc_family_c647x.tar: package/package.ext.xml
ti_sdo_ipc_family_c647x.tar: package/package.rel.dot
ti_sdo_ipc_family_c647x.tar: package/build.cfg
ti_sdo_ipc_family_c647x.tar: package/package.xdc.inc
ti_sdo_ipc_family_c647x.tar: package.bld
ti_sdo_ipc_family_c647x.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ipc_family_c647x.tar.dep
endif
package/rel/ti_sdo_ipc_family_c647x/ti/sdo/ipc/family/c647x/package/package.rel.xml:

ti_sdo_ipc_family_c647x.tar: package/rel/ti_sdo_ipc_family_c647x.xdc.inc package/rel/ti_sdo_ipc_family_c647x/ti/sdo/ipc/family/c647x/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ipc_family_c647x.xdc.inc,package/rel/ti_sdo_ipc_family_c647x.tar.dep)


release release,ti_sdo_ipc_family_c647x: all ti_sdo_ipc_family_c647x.tar
clean:: .clean
	-$(RM) ti_sdo_ipc_family_c647x.tar
	-$(RM) package/rel/ti_sdo_ipc_family_c647x.xdc.inc
	-$(RM) package/rel/ti_sdo_ipc_family_c647x.tar.dep
