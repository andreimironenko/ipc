...
override PKGDIR = ti/sdo/ipc/productview
...
package/%.xdc.inc package/%_ti.sdo.ipc.productview.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ipc.productview" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ipc.productview $@
...
.PHONY: release,ti_sdo_ipc_productview
ti_sdo_ipc_productview.tar: package/package.bld.xml
ti_sdo_ipc_productview.tar: package/package.ext.xml
ti_sdo_ipc_productview.tar: package/package.rel.dot
ti_sdo_ipc_productview.tar: package/build.cfg
ti_sdo_ipc_productview.tar: package/package.xdc.inc
ti_sdo_ipc_productview.tar: icons
ti_sdo_ipc_productview.tar: package.bld
ti_sdo_ipc_productview.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ipc_productview.tar.dep
endif
package/rel/ti_sdo_ipc_productview/ti/sdo/ipc/productview/package/package.rel.xml:

ti_sdo_ipc_productview.tar: package/rel/ti_sdo_ipc_productview.xdc.inc package/rel/ti_sdo_ipc_productview/ti/sdo/ipc/productview/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ipc_productview.xdc.inc,package/rel/ti_sdo_ipc_productview.tar.dep)


release release,ti_sdo_ipc_productview: all ti_sdo_ipc_productview.tar
clean:: .clean
	-$(RM) ti_sdo_ipc_productview.tar
	-$(RM) package/rel/ti_sdo_ipc_productview.xdc.inc
	-$(RM) package/rel/ti_sdo_ipc_productview.tar.dep
